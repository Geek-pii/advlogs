<div class="row">
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_role.form.name") !!}</div>
  ...
  <div class="col-md-4 hidden">
    <div class="font-bold col-blue">{!! trans("admin_role.form.level") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
  ...
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_role.form.slug") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
