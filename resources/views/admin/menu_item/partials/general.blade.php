<div class="row">
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_menu_item.form.menu") !!}</div>
  ...
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_menu_item.form.parent") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
  ...
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_menu_item.form.position") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
...
<div class="row">
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_menu_item.form.type") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
...
<div class="row">
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_menu_item.form.class") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
        <input type="text" class="form-control" name="class"
               value="{{ $menu_item->class ?? old("class") }}">
      </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_menu_item.form.target") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
  ...
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_menu_item.form.active") !!}</div>
