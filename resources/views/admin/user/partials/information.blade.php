<div class="row">
  <div class="col-md-6">
    <div class="font-bold col-blue">{!! trans("admin_user.form.role") !!}</div>
...
<div class="row">
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_user.form.name") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
  ...
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_user.form.email") !!}</div>
    <div class="form-group form-float">
      <div class="form-line">
  ...
  <div class="col-md-4">
    <div class="form-group form-float">
      <div class="font-bold col-blue">{!! trans("admin_user.form.password") !!}</div>
      <div class="form-line">
...
<div class="row">
  <div class="col-md-4">
    <div class="font-bold col-blue">{!! trans("admin_user.form.status") !!}</div>
