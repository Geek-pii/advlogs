...
<div id="catalogue-template" class="hidden">
  <div class="module-item catalogue-item">
    <button type="button" class="btn btn-danger btn-delete btn_delete_this" data-parent=".catalogue-item" data-name=""
            data-value="" data-multi="true">
    </button>
