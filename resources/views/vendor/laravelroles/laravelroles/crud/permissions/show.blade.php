          ...
          <div class="{{ $containerHeaderClass }}">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              ...
              <div class="pull-right">
                @isset($typeDeleted)
                  <a href="{{ route('laravelroles::permissions-deleted') }}"
                     class="btn btn-outline-danger btn-sm float-right" data-toggle="tooltip" data-placement="left"
                     title="{{ trans('laravelroles::laravelroles.tooltips.back-permissions-deleted') }}">
                ...
                @else
                  <a href="{{ route('laravelroles::roles.index') }}"
                     ...
                     title="{{ trans('laravelroles::laravelroles.tooltips.back-permissions') }}">
                    <i class="fa fa-fw fa-reply-all" aria-hidden="true"></i>
              ...
              <div class="col-sm-6 mt-3">
                ...
                @else
                  <a class="btn btn-sm btn-secondary btn-block text-white mb-0"
                     href="{{ route('laravelroles::permissions.edit', $item['permission']->id) }}" data-toggle="tooltip"
                     title="{{ trans("laravelroles::laravelroles.tooltips.edit-permission") }}">
