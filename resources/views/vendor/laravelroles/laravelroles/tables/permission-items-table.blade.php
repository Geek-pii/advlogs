      ...
      @foreach($items as $item)
        <tr>
          ...
          @if($tabletype == 'normal')
            <td>
              <a class="btn btn-sm btn-outline-info btn-block"
                 href="{{ route('laravelroles::permissions.show', $item['permission']->id) }}" data-toggle="tooltip"
                 title="{{ trans('laravelroles::laravelroles.tooltips.show-permission') }}">
          ...
          @if($tabletype == 'deleted')
            ...
            <td>
              <a class="btn btn-sm btn-outline-info btn-block"
                 href="{{ route('laravelroles::permission-show-deleted', $item->id) }}" data-toggle="tooltip"
                 title="{{ trans('laravelroles::laravelroles.tooltips.show-deleted-permission') }}">
