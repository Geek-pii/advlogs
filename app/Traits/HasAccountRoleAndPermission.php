...
trait HasAccountRoleAndPermission
{
    /**
     ...
     */
    public function roles($fillableType = 'account')
    {
     ...
     * @return Collection
     */
    public function getRoles($fillableType = 'account')
    {
    ...
    public function attachRole($role, $companyId = null)
    {
        ...
        return $this->roles()->attach($role, ['company_id' => $companyId]);
    }
     ...
     * @return Collection
     */
    public function getPermissions($fillableType = 'account')
    {
     ...
     * @return bool
     */
    public function hasAllPermissions($permission, $fillableType = 'account')
    {
        foreach ($this->getArrayFrom($permission) as $permission) {
     ...
     * @return bool
     */
    public function checkPermission($permission, $fillableType = 'account')
    {
     ...
     * @return bool
     */
    protected function isAllowed($providedPermission, Model $entity, $fillableType = 'account')
    {
     ...
     * @return null|bool
     */
    public function attachPermission($permission, $companyId)
    {
