        ...
        this.Run = function (config) {
            ...
            this.get = function () {
                ...
                this.createPage = function () {
                    ...
                    html += '<ul class="turn-ul clearfix" data-anim-type="fadeInUp" data-anim-delay="150">';
                    //首页+上一页
                    html += '<li class="tz first"><i class="arrow_carrot-left"></i></li>';
                    if (config.pageIndex > 1)
                        html += '<li class="tz prev"><i class="arrow_carrot-left"></i></li>';
                    else
                        html += '<li class="tz prev"><i class="arrow_carrot-left"></i></li>';
                    ...
                    if (config.pageIndex < config.pageCount)
                        html += '<li class="tz next"><i class="arrow_carrot-right"></i></li>';
                    else
                        html += '<li class="tz next"><i class="arrow_carrot-right"></i></li>';

                    html += '<li class="tz end"><i class="arrow_carrot-right"></i></li>';
